...
public class TCPTransportPolicyMapConfigurator implements PolicyMapConfigurator {
    ...
    private Policy createTCPTransportPolicy(final QName bindingName) {
        return Policy.createPolicy(null, bindingName.getLocalPart() + "_TCPTransport_Policy", List.of(AssertionSet.createAssertionSet(List.of(new TCPTransportAssertion()))));
    }
