...
package wssc.sc2.server;
import jakarta.xml.ws.Holder;


@jakarta.jws.WebService (endpointInterface="wssc.sc2.server.IPingService")
...
public class PingImpl implements IPingService {
   ...
   public void ping( Holder<String> scenario,
         ...
         Holder<String> text){
        System.out.println("The message is here : " + scenario + " " +origin + " " + text);
