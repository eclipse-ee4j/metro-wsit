...
module org.glassfish.metro.wsit.impl {
    ...
    opens com.sun.xml.security.core.ai to java.xml.bind;
    opens com.sun.xml.security.core.dsig to java.xml.bind;
    opens com.sun.xml.security.core.xenc to java.xml.bind;
    opens com.sun.xml.ws.config.metro.parser.jsr109 to java.xml.bind;
    opens com.sun.xml.ws.mex.client.schema to java.xml.bind;
    opens com.sun.xml.ws.policy.impl.bindings to java.xml.bind;
    opens com.sun.xml.ws.rx.mc.protocol.wsmc200702 to java.xml.bind;
    opens com.sun.xml.ws.security.opt.crypto.dsig to java.xml.bind;
    opens com.sun.xml.ws.security.opt.crypto.dsig.keyinfo to java.xml.bind;
    opens com.sun.xml.ws.security.opt.impl.keyinfo to java.xml.bind;
    opens com.sun.xml.ws.security.opt.impl.reference to java.xml.bind;
    opens com.sun.xml.ws.security.secconv.impl.bindings to java.xml.bind;
    opens com.sun.xml.ws.security.secconv.impl.wssx.bindings to java.xml.bind;
    opens com.sun.xml.ws.security.secext10 to java.xml.bind;
    opens com.sun.xml.ws.security.secext11 to java.xml.bind;
    opens com.sun.xml.ws.security.soap11 to java.xml.bind;
    opens com.sun.xml.ws.security.soap12 to java.xml.bind;
    opens com.sun.xml.ws.security.trust.impl.bindings to java.xml.bind;
    opens com.sun.xml.ws.security.trust.impl.wssx.bindings to java.xml.bind;
    opens com.sun.xml.ws.security.wsu10 to java.xml.bind;
    opens com.sun.xml.ws.transport.tcp.servicechannel.stubs to java.xml.bind;
    opens com.sun.xml.ws.tx.at.v10.types to java.xml.bind;
    opens com.sun.xml.ws.tx.at.v11.types to java.xml.bind;
    opens com.sun.xml.ws.tx.coord.v10.types to java.xml.bind;
    opens com.sun.xml.ws.tx.coord.v11.types to java.xml.bind;
    opens com.sun.xml.wss.saml.internal.saml11.jaxb20 to java.xml.bind;
    opens com.sun.xml.wss.saml.internal.saml20.jaxb20 to java.xml.bind;
