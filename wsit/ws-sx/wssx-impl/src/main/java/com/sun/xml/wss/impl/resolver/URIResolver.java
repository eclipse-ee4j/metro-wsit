...
public class URIResolver extends ResourceResolverSpi {
    ...
    private XMLSignatureInput _resolveId(Attr uri, String baseUri) throws ResourceResolverException {
        ...
        Set<Node> resultSet = prepareNodeSet(selectedElem);
     ...
     *
     * For example, content-ID of "foo" may be specified with <code>Content-ID:&lt;foo&gt;</code>
...
//        }
     ...
     *             an empty set.
     */
    private Set<Node> prepareNodeSet(Node node) {
