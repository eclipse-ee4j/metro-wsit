...
class Krb5Context implements GSSContextSpi {
	...
	this.key = key;
        //Add the secretKey into the subject as a private cred
        final AccessControlContext acc = AccessController.getContext();
        final Subject subject = (Subject) AccessController.doPrivileged(new PrivilegedAction() {
